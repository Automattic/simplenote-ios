...
private struct Localization {
    ...
    private static let footerTemplate = NSLocalizedString("Didn’t get an email? Please contact %1$@.", comment: "Footer -> Sign up verification screen. Parameter: %1$@ - support email address")
