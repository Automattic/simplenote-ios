...
extension UIColor {
    ...
    @objc
    static func simplenoteLightPink() -> UIColor {
        return UIColor(red: 227.0 / 255.0, green: 224.0 / 255.0, blue: 226.0 / 255.0, alpha: 1.0)
    }
    ...
    @objc
    static func simplenotePalePurple() -> UIColor {
        return UIColor(red: 182.0 / 255.0, green: 178.0 / 255.0, blue: 184.0 / 255.0, alpha: 1.0)
    }
