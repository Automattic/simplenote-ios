...
class SimplenoteConstants: NSObject {
    ...
    static let passkeyRegistrationURL = currentPasskeyBaseURL.appendingPathComponent("/webauthn/register/verify")
    static let passkeyAuthChallengeURL = currentPasskeyBaseURL.appendingPathComponent("/webauthn/authenticate/start")
    static let verifyPasskeyAuthChallengeURL = currentPasskeyBaseURL.appendingPathComponent("/webauthn/authenticate/verify")
}
