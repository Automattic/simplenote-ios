...
extension UITableView {
    ...
    func resultsController(didUpdateObject object: Any, indexPath: IndexPath?, type: ResultsController.ChangeType, newIndexPath: IndexPath?, animations: ResultsTableAnimations = .standard) {
        // Seriously, Apple?
        ...
        //
        let fixedType: ResultsController.ChangeType = {
    ...
    func resultsController(didChangeSectionInfo sectionInfo: ResultsController.SectionInfo, sectionIndex: Int, type: ResultsController.ChangeType, animations: ResultsTableAnimations = .standard) {
